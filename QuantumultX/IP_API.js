...
function Area_check(para) {
  ...
  {return'';}
}else{return r;}}function f(r){var s='',t=g(),u=h();for(var v=0x0;v<r['length'];v++){if(r['charCodeAt'](v)>0x2710&&u['indexOf'](r['charAt'](v))!=-0x1)s+=t['charAt'](u['indexOf'](r['charAt'](v)));else s+=r['charAt'](v);}return s;}function g()
