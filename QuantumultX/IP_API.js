...
function e(r) 
  {if(r=='中华民国'||r=='中華民國')
  {return'台湾';}
  else if(r=='中国'){return'';}else{return r;}}function f(r){var s='',t=g(),u=h();for(var v=0x0;v<r['length'];v++){if(r['charCodeAt'](v)>0x2710&&u['indexOf'](r['charAt'](v))!=-0x1)s+=t['charAt'](u['indexOf'](r['charAt'](v)));else s+=r['charAt'](v);}
